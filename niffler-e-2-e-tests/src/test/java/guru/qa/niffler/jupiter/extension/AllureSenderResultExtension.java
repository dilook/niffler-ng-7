...
public class AllureSenderResultExtension implements SuiteExtension {
    ...
    private static final String PROJECT_NAME = EXECUTOR + "-" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd't'HH-mm-ss-n"));
    ...
    private static final String ALLURE_RESULTS_PATH = "./niffler-e-2-e-tests/build/allure-results";
    ...
    public void afterSuite() {
        ...
        allureApiClient.createProject(PROJECT_NAME);
        allureApiClient.sendResults(PROJECT_NAME, getResults());
        allureApiClient.generateReport(PROJECT_NAME, EXECUTOR, BUILD_URL, EXECUTION_TYPE);
